namespace Airports_Logic.Services
{
    ...
    public class GeoLocation : ICommand
    {
        ...
        public GeoLocation(IDataHandler handler)
        {
        ...
        {
            var airport = this.handler.Airports.FirstOrDefault(a => a.IATACode == input);
            ...
            {
                Console.WriteLine($"No airport with IATA Code {input}");
            }
        }
    }
}
